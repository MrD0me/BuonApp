...
module.exports = async function afterPack(context) {
  ...
  if (packager.platform.name === 'linux') {
    const metainfoSrc = path.join(packager.projectDir, 'assets/it.buonapp.pos.metainfo.xml');
    const metainfoDest = path.join(appOutDir, 'share/metainfo/it.buonapp.pos.metainfo.xml');
