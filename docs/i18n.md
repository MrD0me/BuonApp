...
Translating BuonApp into Japanese or German does not require creating a tax pack, and adding a tax pack for a new country does not require adding a new UI language.
