...
console.log('\n✅ Test 7: Test page builder');
{
  ...
  assert('80mm test page renders title', buf80.toString('utf8').includes('BuonApp Printer Test'));
  assert('58mm test page renders title', buf58.toString('utf8').includes('BuonApp Printer Test'));
